#!/usr/bin/env python3
"""Apply frozen C2 and final graph representations to full inference outputs."""
...
def main() -> None:
    ...
    for name in args.names:
        ...
        panel([
            (destination / "rgb_inference.png", f"RGB ({width} x {height} inference frame)"),
            (destination / "road_overlay.png", f"Road mask at threshold {float(diagnostics['road_threshold']):g}"),
